...
<html>
    ...
    <body>
        ...
        <div class="w3-container">
            <h1 style="color: #000000; font-family: 'Blinker', sans-serif;">New Product Category</h1>
            <form action="productCategory" method="post" style="max-width: 500px;">
            @csrf
            <div>
                <label style="display: block; color: #000000; font-family: 'Blinker', sans-serif;"><b>New Category</b></label>
                <input style="display: block; color: #000000; font-family: 'Blinker', sans-serif; width: 100%;" 
                type="text" class="w3-input w3-border" name="productCategory" value = "{{old('productCategory')}}">
                <br>
            ...
            @error('Error')
                <div class="error" style="display: block; font-family: 'Blinker', sans-serif; width: 100%; color: red;">{{ $message }}</div>
            @enderror
            </form>
        </div>   
    </body>
